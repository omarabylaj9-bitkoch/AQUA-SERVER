...
Стремительное развитие искусственного интеллекта (AI) требует колоссальных вычислительных мощностей. Современные AI-дата-центры потребляют огромное количество энергии и выделяют гигаватты тепла, которое сейчас просто «выбрасывается» в атмосферу системами охлаждения. 
...
![Макет AQUA-SERVER](hardware/aqua-server-model.png)
*Рисунок 1: Расположение блоков: Серверная стойка ➔ Теплообменник ➔ Модуль дистилляции ➔ Резервуар пресной воды.*

Исходные файлы геометрии для импорта в любые 3D-редакторы доступны в папке `/hardware`.
